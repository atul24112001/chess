                      ...
                      {(provided, snapshot) => {
                        return (
                          <div
                            ...
                            className={`w-10 h-10  md:w-16 md:h-16 xl:w-20 xl:h-20 relative ${
                              (jndex + index) % 2 == 0
                                ? "bg-white"
                                : "bg-[#739552]"
                          ...
                          >
                            ...
                            {isValidMove && (
                              <div className="absolute w-10 h-10  md:w-16 md:h-16 lg:w-20 lg:h-20 flex justify-center items-center">
                                <div
